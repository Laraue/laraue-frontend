...
<i18n lang="json">
{
  "en": {
    ...
    "pdfExtractorTitle": "PDF to JSON Converter",
  ...
  "ru": {
    ...
    "pdfExtractorTitle": "Конвертер PDF в JSON",
